class RegistrationsController < ApplicationController	
	...
	def set_user_session
		session[:user] = @user
		session[:sent_registration_form] = true
	end
	...
	def user_params
		params.require(:user).permit(:first_name, :last_name, :first_name_katakana, :last_name_katakana, :email, :phone, :birthday, :postal_code, :prefecture, :city, :address_details, 
																 ...
																 :request_sampling, :request_research, :request_sales, :request_register, :request_hall, :request_kitchen, :request_dish_washing, :confirming, :password,
