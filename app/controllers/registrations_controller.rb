class RegistrationsController < ApplicationController	
	...
	def user_params
		params.require(:user).permit(:first_name, :last_name, :first_name_katakana, :last_name_katakana, :email, :email_confirmation, :phone, :birthday, :postal_code, :prefecture, :city, :address_details, 
																 ...
																 :daytime_student, :elder, :earnings_over_500, :householder_present, :from_a, :baitoru, :townwork, :enjapan, :mynavi, :shotworks, :an, :friend, :other_application_reason, :gender, :closest_station)
	end
end
